...
create index idx_players_availability on players(availability_start, availability_end);
create index idx_players_coach on players(created_by_coach_id);
create index idx_listings_team on listings(team_id);
create index idx_listings_season on listings(season_start, season_end);
create index idx_inquiries_listing on inquiries(to_listing_id);
create index idx_inquiries_player on inquiries(to_player_id);
